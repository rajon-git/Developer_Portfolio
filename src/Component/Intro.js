...
export default function Intro(){
    ...
    <Box  pt='75px' pb='100px' bg="#2F2FA1">
        <Box w='50%' m='auto'  textAlign='center'>
            <Box mb='10px'>
            <Text fontWeight='bold' color="white" fontSize='3xl'>Hi, I am <Text fontSize='4xl' display='inline' color='#FF9398' id="user-detail-name">MD. Rajon Ahamad</Text>,</Text>
        ...
        <Box >
            <a href='https://drive.google.com/file/d/1rBwqvqWOO2JT82jHw-QfALzRaSNxdDeM/view?usp=sharing' target="_blank"><Button background='none' color='white' outline="1px solid #FF9398" 
