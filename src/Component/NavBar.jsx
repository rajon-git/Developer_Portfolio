      ...
      >
        ...
        >
          ...
          <Flex w="55%" justify="space-between" letterSpacing="1px">
            <Box
              p="5px 15px"
              _hover={{ background: "#57BB99", color: "#004D40" }}
              fontWeight="bolder"
              color="#1976D2"
            >
              <a href="#about">
            ...
            >
              <a href="#contact">
                <Text className="nav-link contact" onClick={handleContact}>
                  CONTACT
                </Text>
              </a>
            </Box>
            <Box
              ...
              color="white"
            >
              <a href="./../Banner/RAJON_MERN.pdf" download>
                {" "}
                <Text className="nav-link resume" id="resume-button-1">
                  RESUME
                </Text>
              </a>
            </Box>
